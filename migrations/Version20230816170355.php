 ...
 */
final class Version20230816170355 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe CHANGE user_id user_id INT DEFAULT NULL, CHANGE is_public is_public TINYINT(1) DEFAULT 0');
    }
}
